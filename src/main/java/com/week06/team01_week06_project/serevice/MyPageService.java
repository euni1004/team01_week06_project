...
public class MyPageService {
    ...
    public GlobalResDto<MyGameList> getMyPost(UserDetailsImpl userDetails){
        ...
        List<GamePostResDto> gamePostResDtos = getMyRecruit(userDetails);
    ...
    public List<GamePostResDto> getMyRecruit(UserDetailsImpl userDetails) {
        Member member = memberRepository.findByUserid(userDetails.getAccount().getUserid()).orElseThrow(
                () -> new CustomException(ErrorCode.NOT_FOUND_MEMBER)
        );
